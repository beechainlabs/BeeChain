...
This repository contains the execution component of a BeeChain node. It
...
[EVM implementation](https://docs.BeeChain.AI/beechain-arch/execution/native-compilation),
its [database implementation](https://docs.BeeChain.AI/beechain-arch/execution/monaddb),
and the high-level [transaction scheduling](https://docs.BeeChain.AI/bee-arch/execution/parallel-execution).
The other main repository is [beechain-bft](https://github.com/beechainlabs/beechain-bft),
...
As explained in the [hardware requirements](https://docs.beechain.ai/beechain-arch/hardware-requirements),
a Beechain node requires a relatively recent CPU. Execution explicitly
...
the execution daemon, `build/cmd/beechain`. This binary can provide block
